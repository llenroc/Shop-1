...
(function ($) {
    ...
    $.extend(true, $.hik.jtable.prototype, {
        ...
        //Override _create function to change actions according to Infrastructure system
        _create: function () {
            var self = this;
            base._create.apply(self, arguments);

            if (self.options.actions.listAction) {
                self._adaptListActionforInfrastructure();
            }

            if (self.options.actions.createAction) {
                self._adaptCreateActionforInfrastructure();
            }

            if (self.options.actions.updateAction) {
                self._adaptUpdateActionforInfrastructure();
            }

            if (self.options.actions.deleteAction) {
                self._adaptDeleteActionforInfrastructure();
            }
        },

        //LIST ACTION ADAPTER
        _adaptListActionforInfrastructure: function () {
            var self = this;
            ...
            self.options.actions.listAction = function (postData, jtParams) {
                return $.Deferred(function ($dfd) {
                    ...
                    originalListAction.method(input)
                        ...
                        .fail(function (error) {
                            self._handlerForFailOnInfrastructureRequest($dfd, error);
                        });
                });
            };
        },
        ...
        _adaptCreateActionforInfrastructure: function () {
            var self = this;
        ...
        _adaptUpdateActionforInfrastructure: function () {
            var self = this;
        ...
        _adaptDeleteActionforInfrastructure: function () {
            var self = this;
        ...
        _handlerForFailOnInfrastructureRequest: function ($dfd, error) {
        ...
        _showError: function (message) {
            //do nothing since Infrastructure handles error messages!
        }
