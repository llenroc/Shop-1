 ...
 */
appModule.directive('permissionTree', [function () {
    return {
        restrict: 'E',
        ...
        link: function ($scope, element, attr) {
            ...
            function initializeTree() {
                ...
                var treeData = $.map($scope.editData.permissions,function (item) {
                    return {
                        id: item.name,
                        ...
                        state: {
                            opened: true,
                            selected: $scope.editData.grantedPermissionNames.contains(item.name)
                        }
                    };
                });
                ...
                $tree.jstree({
                    ...
                    "types": {
                        "default": {
                            "icon": "icon-folder-close tree-item-icon-color icon-lg"
                        },
                        "file": {
                            "icon": "icon-file-text tree-item-icon-color icon-lg"
                        }
                    },
                    'checkbox': {
