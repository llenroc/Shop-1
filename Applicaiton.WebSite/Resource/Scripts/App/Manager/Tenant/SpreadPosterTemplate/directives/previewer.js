 ...
 */
appModule.directive('previewer', [
    function () {
        return {
            scope: {
                spreadPosterTemplate: '='
            },
            templateUrl: '/Areas/Manager/Views/Tenant/SpreadPosterTemplate/previewer.cshtml',
            link: function ($scope, element, attr) {
                ...
                $scope.draw = function (p) {
                    var path = $scope.spreadPosterTemplate.template;
                    var parameters = $scope.spreadPosterTemplate.parameters;
                    var targets = [];
                    var img = new Image();
                    var width;
                    var height;
                ...
                $scope.$watch('spreadPosterTemplate', function (newValue, oldValue) {
