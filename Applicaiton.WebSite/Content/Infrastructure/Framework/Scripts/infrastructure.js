...
************************************************************/
    ...
    ************************************************************/
    ...
    infrastructure.toast = infrastructure.toast || {};
    infrastructure.toast.info = function (message) {
        return $.toast.info(message);
    };
    infrastructure.toast.success = function (message) {
        return $.toast.success(message);
    };
    infrastructure.toast.error = function (message) {
        return $.toast.error(message);
    };
    infrastructure.toast.loading = function (message) {
