...
namespace Application.Chat
{
    ...
    public class ChatMessageManager : ApplicationDomainServiceBase, IChatMessageManager
    {
        ...
        public void SendMessage(UserIdentifier sender, UserIdentifier receiver, string message, string senderTenancyName, string senderUserName, string senderAvatar)
        {
            ...
            HandleSenderUserInfoChange(sender, receiver, senderTenancyName, senderUserName, senderAvatar);
        }
        ...
        private void HandleSenderUserInfoChange(UserIdentifier sender, UserIdentifier receiver, string senderTenancyName, string senderUserName, string senderAvatar)
        {
            ...
            if (senderAsFriend.FriendTenancyName == senderTenancyName &&
                ...
                senderAsFriend.FriendAvatar == senderAvatar)
            {
                return;
            }
            ...
            friendship.Avatar = senderAvatar;
